...
hotel_bookings <- read.csv("ho.tel_bookings.csv")

Instead of this step, I dropped the CSV in my GitHub file, then in RStudio, files, I clicked the csv and "import".
```
