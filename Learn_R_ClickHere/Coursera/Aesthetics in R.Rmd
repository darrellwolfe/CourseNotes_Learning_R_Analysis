...
```{r look at data, eval=FALSE, include=TRUE}
head(hotel_bookings)
```

```{r look at column names, eval=FALSE, include=TRUE}
...
```{r loading and installing ggplot2, eval=FALSE, include=TRUE}
...
```{r example chart, eval=FALSE, include=TRUE}
...
```{r pressure 1, eval=FALSE, include=TRUE}
ggplot(data = hotel_bookings) +
  geom_bar(mapping = aes(x = distribution_channel, ))
```
...
```{r pressure 2, eval=FALSE, include=TRUE}
ggplot(data = hotel_bookings) +
  geom_bar(mapping = aes(x = distribution_channel, ))
```
...
```{r creating a plot 1, eval=FALSE, include=TRUE}
ggplot(data = hotel_bookings) +
  geom_bar(mapping = aes(x = distribution_channel)) +
  facet_wrap(~ ) # Here
```
...
Try it out below:
```{r creating a plot 2 with rotated labels, eval=FALSE, include=TRUE}
ggplot(data = hotel_bookings) +
  geom_bar(mapping = aes(x = distribution_channel)) +
...
```{r creating a plot, eval=FALSE, include=TRUE}
ggplot(data = hotel_bookings) +
  geom_bar(mapping = aes(x = distribution_channel)) +
